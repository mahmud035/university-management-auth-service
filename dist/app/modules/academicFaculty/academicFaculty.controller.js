...
const getAllFaculties = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.getAllFaculties(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.getSingleFaculty(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const deleteFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.deleteByIdFromDB(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
