...
const createSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_services_1.AcademicSemesterService.createSemester(
...
const getAllSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_services_1.AcademicSemesterService.getAllSemesters(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicSemester_services_1.AcademicSemesterService.getSingleSemester(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_services_1.AcademicSemesterService.updateSemester(
        id,
        updatedData
      );
    (0, sendResponse_1.default)(res, {
...
const deleteSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicSemester_services_1.AcademicSemesterService.deleteSemester(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
